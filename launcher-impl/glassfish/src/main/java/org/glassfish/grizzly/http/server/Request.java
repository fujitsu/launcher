...
public class Request {
    ...
    private static boolean disableSchemeMappingValidation = Boolean.getBoolean("com.fujitsu.launcher.http.disableSchemeMappingValidation");
        ...
        if (httpServerFilter != null) {
            ...
            if (backendConfiguration != null) {
                ...
                if (backendConfiguration.getScheme() != null) {
                    ...
                    String suggestedScheme = request.getHeader(backendConfiguration.getSchemeMapping());
